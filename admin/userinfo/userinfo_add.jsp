                              ...
                              <c:if test="${utype==2}">
                               <label class="col-sm-3 control-label"><font color="red">*</font>工号 </label>
								...
								<div class="col-sm-9 form-inline"  >
                                                    <input id="sno" name="sno" size="35" class="form-control"   type="text" value=""  tip="请输入学号/工号" />
								</div>
							</div>
						</div>
					</div>
					   ...
					   <div class="row rowmargin">
						<div class="col-sm-7">
							<div class="form-group">
								...
								<div class="col-sm-9 form-inline"  >
                                                    <input id="idno" name="idno" size="35" class="form-control"   type="text" value=""  tip="请输入身份证号" />
								</div>
							</div>
						</div>
					</div>
               ...
               <div class="row rowmargin">
						<div class="col-sm-7">
							<div class="form-group">
								...
								<div class="col-sm-9 form-inline"  >
                                                    <input id="xy" name="xy" size="35" class="form-control"   type="text" value=""  tip="请输入学院" />
								</div>
							</div>
						</div>
					</div>
    ...
    $("#addForm").validate({
        ...
        rules: {
                                                    sno:{
                                                                    required:true,
                                                                    remote: {
                                        url: "<%=path%>/userinfo_snoExist.action",
                                                type: "post",
                                                dataType: "json",
                                                data: {
                                           sno: function (){ return $("#sno").val();},
                                           utype: function (){ return $("#utype").val();}
                                        },
