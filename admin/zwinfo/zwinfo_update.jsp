...
<div class="page-content">
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <form action="<%=path%>/zwinfo_update.action" method="post" id="addForm">
                 <input name="id" type="hidden" value="${zwinfo.id}"/>
                <div class="container-fluid">
					                        <div class="row rowmargin">
                            <div class="col-sm-7">
                                <div class="form-group">
                                                                            <label class="col-sm-3 control-label"><font color="red">*</font>编号 </label>
                                                                        <div class="col-sm-9 form-inline"  >
                                            <input id="name" name="name" size="35" class="form-control"   type="text" value="${zwinfo.name}"  tip="请输入编号" />
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    $("#addForm").validate({
        ...
        rules: {
                        name:{
                                    required:true,
                                    remote: {
                    url: "<%=path%>/zwinfo_nameExist.action",
                            type: "post",
                            dataType: "json",
                            data: {
